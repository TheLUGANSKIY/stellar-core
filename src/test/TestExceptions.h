...
class ex_DIRECT_DEBIT_MALFORMED
{
};
class ex_DIRECT_DEBIT_NO_OWNER
{
};
class ex_DIRECT_DEBIT_NO_DEBIT
{
};
class ex_DIRECT_DEBIT_UNDERFUNDED
{
};
class ex_DIRECT_DEBIT_OWNER_UNDERFUNDED
{
};
class ex_DIRECT_DEBIT_OWNER_NO_TRUST
{
};
class ex_DIRECT_DEBIT_OWNER_NOT_AUTHORIZED
{
};
class ex_DIRECT_DEBIT_NO_DESTINATION
{
};
class ex_DIRECT_DEBIT_DESTINATION_NO_TRUST
{
};
class ex_DIRECT_DEBIT_DESTINATION_NOT_AUTHORIZED
{
};
class ex_DIRECT_DEBIT_LINE_FULL
{
};
class ex_DIRECT_DEBIT_NO_ISSUER
{
};
